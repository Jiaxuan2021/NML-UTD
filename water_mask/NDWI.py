...
# Read the data
NIR_path = fr'..\dataset\ningxiang_dataset_2target\select_bands\NIR.tif'
GREEN_path = fr'..\dataset\ningxiang_dataset_2target\select_bands\GREEN.tif'
...
# np.save(fr'./NDWI_{parent_dir}.npy', water_mask2)
